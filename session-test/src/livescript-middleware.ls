...
module.exports = (options = {}) ->
  ...
  return (req, res, next) ->
    ...
    console.log "livescript-middleware: path => #{req.url}"
    path = url.parse req.url .pathname
    path = (require \path).basename path

    return next! unless /\.js$/.test path
    console.log "livescript-middleware: got it"
    ...
    console.log "livescript-middleware: js-path => #{js-path}"
    console.log "livescript-middleware: ls-path => #{ls-path}"
